				...
				<div class="col-xl-12">
					<div class="card mb-0">
						...
						<ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-bs-toggle="tab" href="#semua" role="tab"> <i class="uil uil-user-circle font-size-20"></i> <span class="d-none d-sm-block">Semua</span> </a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#belumbayar" role="tab"> <i class="uil uil-clipboard-notes font-size-20"></i> <span class="d-none d-sm-block">Belum Bayar</span> </a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#dikemas" role="tab"> <i class="uil uil-envelope-alt font-size-20"></i> <span class="d-none d-sm-block">Dikemas</span> </a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#dikirim" role="tab"> <i class="uil uil-envelope-alt font-size-20"></i> <span class="d-none d-sm-block">Dikirim</span> </a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#selesai" role="tab"> <i class="uil uil-clipboard-notes font-size-20"></i> <span class="d-none d-sm-block">Selesai</span> </a>
							</li>
						</ul>
						<!-- Tab content -->
						<div class="tab-content p-4">
							<div class="tab-pane active" id="semua" role="tabpanel">
								<div>
									<div>
										<h5 class="font-size-16 mb-4">Semua Pesanan</h5>
							...
							<div class="tab-pane" id="belumbayar" role="tabpanel">
								<div>
									<h5 class="font-size-16 mb-4">Belum Bayar</h5>
									<div class="table-responsive">
										<table class="table table-nowrap table-hover mb-0">
											<thead>
												<tr>
														...
														while ($data = mysqli_fetch_array($eksekusiDikemas)) : ?>
															<tr>
																...
																<td><?php echo "Dikirim Sebelum ";
																	$sesudah = date('d-m-Y', strtotime('+3 days'));
																	echo  $sesudah ?></td>
																<td><span class="badge bg-soft-secondary font-size-12">Dikemas</span></td>
																<td>
							...
							<div class="tab-pane" id="dikirim" role="tabpanel">
								<div>
									<div>
										<h5 class="font-size-16 mb-4">Dikirim</h5>
										<div class="table-responsive">
											<table class="table table-nowrap table-hover mb-0">
												<thead>
													<tr>
													...
													if ($eksekusisends == null) {
														...
														while ($data = mysqli_fetch_array($eksekusisends)) : ?>
															<tr>
																...
																<td><span class="badge bg-soft-info font-size-12">Dikirim</span></td>
																<td>
