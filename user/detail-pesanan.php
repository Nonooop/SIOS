                    ...
                    <div class="card" style="box-shadow: none;">
                        <div class="card-body">
                            ...
                            <?php } elseif ($data['status'] == 'Belum Bayar') { ?>
                                <span class="badge bg-warning font-size-12 ms-2"><?php echo $data['status'], "<br>"; ?></span></h4>
                            <?php } ?>
                            <div class="mb-4">
                                <img src="../assets/images/logo-nya.png" alt="logo" height="50" />
                            </div>
                            <div class="text-muted">
                                <p class="mb-1">Jl. Veteran No.74, Nagri Kaler, Kec. Purwakarta, Kabupaten Purwakarta, Jawa Barat 41115</p>
                                <p class="mb-1"><i class="bx bx-mail-send me-1"></i> info@sios.ac.id</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="text-muted text-sm-end">
                                        ...
                                        <div class="mt-4">
                                            <h5 class="font-size-16 mb-1">No Pesanan:</h5>
                            ...
                            <div class="py-2">
                                <h5 class="font-size-15">Daftar Pesanan</h5>
                                        ...
                                        <tbody>
                                            <?php while ($data = mysqli_fetch_array($eksekusibayar)) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-15 mb-1"><?php echo $data['nama_barang'] ?></h5>
                                                    </td>
