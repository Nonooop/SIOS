        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-body">
                            <img src="../assets/images/small/sepatu.png" width="100%">
                        </div> <!-- end card-body-->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                ...
                <div class="col-xl-4">
                    <div class="card bg-primary">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-sm-8">
                                    <p class="text-white font-size-18">Buat <b>bisnismu</b> lebih baik bersama <b>kami</b> <i class="mdi mdi-arrow-right"></i></p>
                                    <div class="mt-4">
                                        <a href="cart.php" class="btn btn-success waves-effect waves-light">Checkout Sekarang!</a>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="mt-4 mt-sm-0">
                                        <img src="../assets/images/setup-analytics-amico.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end card-body-->
                    ...
                    <div class="card" style="margin-top: -10px;">
                        <div class="card-body" style="margin-top: -10px;">
                            ...
                            <h5 class="card-title mb-4">Penjualan Produk Terbaik</h5>
                                            ...
                                            <div class="product-box">
                                                ...
                                                <div class="product-img pt-4 px-4"><a href="detail-barang.php?id=<?php echo $data['id_barang']; ?>">
                                                    ...
                                                    <div class="product-wishlist" style="padding: 10px;">
                                                        <a class="bg-info btn-sm edit" title="Keranjang" data-bs-toggle="modal" data-bs-target=".add<?php echo $data['id_barang']; ?>">
                                                                ...
                                                                <form action="../admin/inputan/keranjang-input-user.php" method="POST">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="nama" placeholder="Masukkan Jumlah Barang" name="kuantitas" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer border-top-0 d-flex justify-content-center">
