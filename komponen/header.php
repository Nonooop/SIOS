...
<head>
    ...
    <meta charset="utf-8" />
    <title>SIOS Make Your Order</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="SIOS Make Your Order" name="description" />
    <meta content="SIOS" name="author" />
    <!-- App favicon -->
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.php" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <img src="../assets/images/logo-ku.png" alt="" height="30">
                            </span>
                        </a>
                    </div>
                    ...
                    <?php
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="profil.php"><i class="uil uil-user-circle font-size-18 align-middle text-muted me-1"></i> <span class="align-middle">Profil Saya</span></a>
                                <a class="dropdown-item" href="myorder.php"><i class="uil uil-wallet font-size-18 align-middle me-1 text-muted"></i> <span class="align-middle">Pesanan Saya</span></a>
                                    ...
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                                                <i class="uil-flask me-2"></i>Katalog <div class="arrow-down"></div>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="howtoorder.php">
                                                <i class="uil-home-alt me-2"></i> Cara Pesan
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="tentangkami.php">
                                                <i class="uil-home-alt me-2"></i> Jelajahi SIOS
                                            </a>
                                        </li>
