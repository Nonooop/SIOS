...
<head>
	...
	<meta content="Themesbrand" name="SIOS Make Your Order" />
	<!-- App favicon -->
			...
			<div class="row" style="margin-top: -5rem; margin-bottom: -2rem;">
				<div class="col-lg-12">
					<div class="text-center">
						<a href="user/index.php" class="mb-5 d-block auth-logo"> <img src="assets/images/logo-nya.png" alt="" height="100" class="logo logo-dark">  </a>
					</div>
				</div>
			</div>
				...
				<div class="col-md-8 col-lg-6 col-xl-5">
					...
					<div class="mt-5 text-center" >
						<p>©
							...
							</script> SIOS. dibuat oleh Maulana Hanhan</p>
					</div>
				</div>
			</div>
			<!-- end row -->
