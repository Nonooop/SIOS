        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div>
                        <!-- center modal -->
                        <button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".modal" style="margin-bottom: 1rem;"><i class="mdi mdi-plus me-1"></i>Tambahkan Pesanan</button>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Tambahkan Pesanan</h5>
                                        ...
                                        <form action="inputan/pesanan-input.php" method="POST" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nama" placeholder="Masukan Nama Penerima" name="nama">

                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-xl-6 col-md-6">
                                                            <label for="iduser">Email Penerima</label>
                                                            <input type="text" class="form-control" id="nama" placeholder="Masukan Email" name="email">
                                                        </div>
                                                        <div class="col-xl-6 col-xl-6">
                                                            <label for="iduser">Telepon Penerima</label>
                                                            <input type="text" class="form-control" id="nama" placeholder="Masukan Telepon" name="telepon">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-4">
                                                            <label for="iduser">Kota</label>
                                                            <input type="text" class="form-control" id="nama" placeholder="Masukan Nama Kota atau Provinsi" name="kota">
                                                        </div>
                                                        <div class="col-xl-4">
                                                            <label for="iduser">Kode POS</label>
                                                            <input type="text" class="form-control" id="nama" placeholder="Masukan Kode Pos" name="pos">
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="iduser">Metode Pembayaran</label>
                                                ...
                                                <div class="modal-body">
                                                    <form action="update/update-pesanan.php" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="iduser">Alamat</label>
                                                                <textarea class="form-control" id="nama" value="<?php echo $setpro['alamat_penerima'] ?>" name="alamat"></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-xl-4">
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        <label for="iduser">Kode POS</label>
                                                                        <input type="text" class="form-control" id="nama" value="<?php echo $setpro['kode_pos'] ?>" name="pos">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="iduser">Metode Pembayaran</label>
                                                                <select class="form-control form-select" title="Country" name="pembayaran">
                                                                    <option value="<?php echo $setpro['id_pembayaran'] ?>">Pilih Metode</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="iduser">Status Pesanan</label>
