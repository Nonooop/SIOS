		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12">
					<div>
						<!-- center modal -->
						<button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" style="margin-bottom: 1rem;"><i class="mdi mdi-plus me-1"></i>Tambahkan Katalog</button>

						<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title">Tambahkan Katalog</h5>
										...
										<form action="inputan/katalog-input.php" method="POST">
											<div class="modal-body">
												<div class="form-group">
													<label for="iduser">Nama Katalog</label>
								...
								<?php while ($data = mysqli_fetch_array($eksekusi)) : ?>
									<tr>
										...
										<td>
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<form action="update/update-katalog.php" method="POST">
																<div class="modal-body">
																	<div class="form-group">
																		<label for="iduser">ID Katalog</label><br>
											...
											<a class="btn btn-outline-secondary btn-sm " href="delete/delete-katalog.php?id=<?php echo $data['id_katalog']; ?>" name="del" onclick="return confirm('Yakin Hapus data?');">
