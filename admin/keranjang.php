                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Tambahkan Keranjang</h5>
                                        ...
                                        <form action="inputan/keranjang-input.php" method="POST" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="resume" name="jml">
                                                </div>
                                            </div>
                                ...
                                <?php while ($data = mysqli_fetch_array($eksekusii)) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-outline-secondary btn-sm " href="delete/delete-keranjang.php?id=<?php echo $data['id_cart']; ?>" name="del" onclick="return confirm('Yakin Hapus data?');">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update/update-keranjang.php" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="iduser">Jumlah</label>
                                                                <input type="text" class="form-control" id="nama" value="<?php echo $setpro['kuantitas'] ?>" name="jml">
                                                            </div>
