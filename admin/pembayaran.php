        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div>
                        <!-- center modal -->
                        <button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" style="margin-bottom: 1rem;"><i class="mdi mdi-plus me-1"></i>Tambahkan Pembayaran</button>
                                        ...
                                        <form action="inputan/pembayaran-input.php" method="POST">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nama" placeholder="Masukan Nama Pembayaran" name="nama">
                                                </div>
                                                <div class="form-group">
                                                    <label for="iduser">Nama Akun</label>
                                                    <input type="text" class="form-control" id="nama" placeholder="Masukan Nama Akun" name="namaakun">
                                                </div>
                                                <div class="form-group">
                                                    <label for="iduser">No Akun</label>
                                                    <input type="text" class="form-control" id="nama" placeholder="Masukan No Akun" name="noakun">
                                                </div>
                                                <div class="form-group">
                                ...
                                <?php while ($data = mysqli_fetch_array($eksekusi)) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-outline-secondary btn-sm " href="delete/delete-pembayaran.php?id=<?php echo $data['id_pembayaran']; ?>" name="del" onclick="return confirm('Yakin Hapus data?');">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="update/update-pembayaran.php" method="POST" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="iduser">ID Pembayaran</label><br>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="iduser">Metode Pembayaran</label>
                                                                        <select class="form-control form-select" title="Country" name="metode">
                                                                            <option value="<?php echo $setpro['metode'] ?>">Pilih Metode</option>
                                                                            <option value="Bank">Bank</option>
                                                                            <option value="Paypal">Paypal</option>
                                                                        </select>
                                                                    </div>
